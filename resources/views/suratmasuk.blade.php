...
<html lang="en">
  ...
  <body>
   ...
   <h1>Tabel Surat Masuk</h1>
    <a href="http://127.0.0.1:8000/tambahmasuk" class="btn btn-create">Buat Surat Baru</a>
        ...
        @foreach ($data as $row )
             <tr>
              <td>{{ $row->id }}</td>
                ...
                <td>
                    <a href="/tampilkandata/{{ $row->id }}" class="btn btn-edit">edit</a>
                    <a href="/tampilmasuk/{{ $row->id }}" class="btn btn-edit">lihat</a>
                     <a href="/delete/{{ $row->id }}" class="btn btn-edit">hapus</a>
                </td>
            </tr>
        @endforeach
