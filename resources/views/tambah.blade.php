...
<html lang="en">
  ...
  <body>
    <form  enctype="multipart/form-data" class="form" action="/insertdata" method="POST">
    @csrf

    <div class="form-group">
        <label for="nomor_surat">Nomor Surat</label>
        <input type="text" name="nomor_surat" name="nomor_surat" id="nomor_surat" class="form-control" required>
    </div>
